...
export default function AllPriceDetail({priceToGet, allExpenses, currentBuyer}) {
    ...
    <div>
        ...
        <div className="form-row" style={{display:'flex', justifyContent:'space-between'}}>
            <button type="submit" onClick={allExpenses}>previous</button>
            <button type="submit" onClick={priceToGive}>next</button>
        </div>
    </div>
  )
}
